...
EOPAGE;
    ...
    Synopsis (5000 character Maximum)<br> <textarea maxlength=5000 name="synopsis" rows="4" cols="50">$restaurantOldValues->synopsis</textarea>
    <br><br>

    <input type="submit" name="submit1" value="Submit Changes">
    <a href="./index.php"><input type="button" value="Return to Main Page"/></a>
</form>
<form action="./deleted.php" onsubmit='return checkIntent("Are you sure you want this record from our database?");' method="post">
